  ...
  const handleSubmitForApproval = () => {
    if (completionNotes.trim()) {
      ...
      toast({
        ...
        description:
          "Please add completion notes before submitting for approval.",
        variant: "destructive",
      });
    }
  };
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="space-y-2">
                  ...
                  <Badge
                    className={`${getStatusColor(ticket.status)} border justify-center py-1.5`}
                  >
                ...
                <div className="space-y-2">
                  ...
                  <Badge
                    className={`${getPriorityColor(ticket.priority)} border justify-center py-1.5`}
                  >
                ...
                {ticket.type && (
                  <div className="space-y-2">
                    ...
                    <Badge
                      className={`${getTypeColor(ticket.type)} border justify-center py-1.5`}
                    >
                ...
                {ticket.category && (
                  <div className="space-y-2">
                    ...
                    <Badge
                      variant="outline"
                      className="justify-center py-1.5 border-gray-200"
                    >
                      {ticket.category}
                    </Badge>
                  </div>
                    ...
                    {ticket.proposedDate && (
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {formatDate(ticket.proposedDate)}
                          </p>
                        </div>
                      </div>
                    )}
      ...
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Add completion notes summarizing the work performed and resolution
              details.
            </DialogDescription>
          </DialogHeader>
